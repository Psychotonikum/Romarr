...
using Romarr.Http.Authentication;
using Romarr.SignalR;
using Romarr.Api.V3.System;
using Romarr.Api.V5.Game;
using Romarr.Http;
using Romarr.Http.ClientSchema;
using Romarr.Http.ErrorManagement;
using Romarr.Http.Frontend;
using Romarr.Http.Middleware;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddLogging(b =>
            {
                ...
                b.AddFilter("Romarr.Http.Authentication.ApiKeyAuthenticationHandler", LogLevel.Information);
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v3", new OpenApiInfo
                {
                    Version = "3.0.0",
                    Title = "Romarr",
                    Description = "Romarr API docs - The v3 API docs apply to both v3 and v4 versions of Romarr. Some functionality may only be available in v4 of the Romarr application.",
                    License = new OpenApiLicense
                    {
                        Name = "GPL-3.0",
                        Url = new Uri("https://github.com/Romarr/Romarr/blob/develop/LICENSE")
                    }
                });
                ...
                c.SwaggerDoc("v5", new OpenApiInfo
                {
                    Version = "5.0.0",
                    Title = "Romarr",
                    Description = "Romarr API docs - The v5 API docs apply to Romarr v5 only.",
                    License = new OpenApiLicense
                    {
                        Name = "GPL-3.0",
                        Url = new Uri("https://github.com/Romarr/Romarr/blob/develop/LICENSE")
        ...
        public void Configure(IApplicationBuilder app,
                              ...
                              RomarrErrorPipeline errorHandler)
        {
