...
namespace Romarr.Update.Test
{
   ...
   public class UpdateProviderStartFixture : TestBase
    {
        private const string UPDATE_FOLDER = @"C:\Temp\romarr_update\romarr\";
        private const string BACKUP_FOLDER = @"C:\Temp\romarr_update\romarr_backup\";
        private const string TARGET_FOLDER = @"C:\Romarr\";
        ...
        [Test]
        public void should_stop_romarr_service_if_installed_and_running()
        {
        ...
        [Test]
        public void should_not_stop_romarr_service_if_installed_but_not_running()
        {
            WithInstalledService();
        ...
        [Test]
        public void should_not_stop_romarr_service_if_service_isnt_installed()
        {
        ...
        [Test]
        public void should_kill_romarr_process_if_running()
        {
            var processes = Builder<ProcessInfo>.CreateListOfSize(2).Build().ToList();

            Mocker.GetMock<IProcessProvider>()
                .Setup(c => c.GetProcessByName(ProcessProvider.RomarrProcessName))
                .Returns(processes);
            ...
            Mocker.GetMock<IProcessProvider>().Verify(c => c.KillAll(ProcessProvider.RomarrProcessName), Times.Once());
        }

        [Test]
        public void should_not_kill_romarr_process_not_running()
        {
            Mocker.GetMock<IProcessProvider>()
                .Setup(c => c.GetProcessByName(ProcessProvider.RomarrProcessName))
        ...
        private void VerifyProcessRestart()
        {
            ...
            Mocker.GetMock<IProcessProvider>()
                .Verify(c => c.Start(TARGET_FOLDER + "Romarr.exe"), Times.Once());
        }
