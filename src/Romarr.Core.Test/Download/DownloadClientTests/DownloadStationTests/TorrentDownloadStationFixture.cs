...
using Romarr.Core.Download.Clients.DownloadStation;
using Romarr.Core.Download.Clients.DownloadStation.Proxies;
using Romarr.Core.MediaFiles.TorrentInfo;
using Romarr.Core.Parser.Model;
using Romarr.Test.Common;

namespace Romarr.Core.Test.Download.DownloadClientTests.DownloadStationTests
{
    [TestFixture]
    public class TorrentDownloadStationFixture : DownloadClientFixtureBase<TorrentDownloadStation>
    {
        ...
        protected string _category = "romarr";
        ...
        protected override RemoteRom CreateRemoteGameFile()
        {
            var rom = base.CreateRemoteGameFile();
