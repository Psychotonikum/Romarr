...
using Romarr.Core.Download.Clients.Transmission;
using Romarr.Core.Download.Clients.Vuze;
using Romarr.Core.Test.Download.DownloadClientTests.TransmissionTests;

namespace Romarr.Core.Test.Download.DownloadClientTests.VuzeTests
{
    [TestFixture]
    public class VuzeFixture : TransmissionFixtureBase<Vuze>
    {
        ...
        public async Task Download_should_return_unique_id()
        {
            ...
            var remoteRom = CreateRemoteGameFile();
        ...
        public async Task Download_with_GameDirectory_should_force_directory()
        {
            ...
            Mocker.GetMock<ITransmissionProxy>()
                .Verify(v => v.AddTorrentFromData(It.IsAny<byte[]>(), @"C:/Downloads/Finished/romarr", It.IsAny<TransmissionSettings>()), Times.Once());
        }
        ...
        public async Task Download_with_category_should_force_directory()
        {
            ...
            Mocker.GetMock<ITransmissionProxy>()
                  .Verify(v => v.AddTorrentFromData(It.IsAny<byte[]>(), @"C:/Downloads/Finished/transmission/romarr", It.IsAny<TransmissionSettings>()), Times.Once());
        }
        ...
        public void should_exclude_items_not_in_category()
        {
            ...
            _downloading.DownloadDir = @"C:/Downloads/Finished/transmission/romarr";
        ...
        public void should_exclude_items_not_in_GameDirectory()
        {
            ...
            _downloading.DownloadDir = @"C:/Downloads/Finished/romarr/subdir";
