...
using Romarr.Core.Download.Clients.Nzbget;
using Romarr.Core.Download.Clients.NzbVortex;
using Romarr.Core.Download.Clients.NzbVortex.Responses;
using Romarr.Core.RemotePathMappings;
using Romarr.Test.Common;

namespace Romarr.Core.Test.Download.DownloadClientTests.NzbVortexTests
{
    [TestFixture]
