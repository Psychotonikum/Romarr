...
using Romarr.Core.Download.Clients.QBittorrent;
using Romarr.Core.Exceptions;
using Romarr.Core.MediaFiles.TorrentInfo;
using Romarr.Test.Common;

namespace Romarr.Core.Test.Download.DownloadClientTests.QBittorrentTests
{
    [TestFixture]
    public class QBittorrentFixture : DownloadClientFixtureBase<QBittorrent>
    {
        ...
        {
            var httpHeader = new HttpHeader();
            httpHeader["Location"] = "http://test.romarr.tv/not-a-real-torrent.torrent";
        ...
        {
            const string category = "tv-romarr";
            GivenGlobalSeedLimits(1.0f);
