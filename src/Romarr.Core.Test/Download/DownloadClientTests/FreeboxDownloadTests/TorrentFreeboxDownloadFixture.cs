...
using Romarr.Core.Download.Clients.FreeboxDownload;
using Romarr.Core.Download.Clients.FreeboxDownload.Responses;
using Romarr.Core.Parser.Model;

namespace Romarr.Core.Test.Download.DownloadClientTests.FreeboxDownloadTests
{
    [TestFixture]
