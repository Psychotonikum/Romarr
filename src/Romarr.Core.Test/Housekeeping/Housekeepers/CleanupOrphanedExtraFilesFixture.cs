...
namespace Romarr.Core.Test.Housekeeping.Housekeepers
{
    ...
    public class CleanupOrphanedExtraFilesFixture : DbTest<CleanupOrphanedExtraFiles, OtherExtraFile>
    {
        ...
        [Test]
        public void should_delete_extra_files_that_dont_have_a_coresponding_gameFile_file()
        {
            var game = Builder<Game>.CreateNew()
                                        .BuildNew();
        ...
        [Test]
        public void should_not_delete_extra_files_that_have_a_coresponding_gameFile_file()
        {
            var game = Builder<Game>.CreateNew()
                                        .BuildNew();
        ...
        [Test]
        public void should_delete_extra_files_that_have_gameFilefileid_of_zero()
        {
            var game = Builder<Game>.CreateNew()
                                        .BuildNew();
