...
{
    [TestFixture]
    public class DownloadedGameFilesCommandServiceFixture : CoreTest<DownloadedGameFilesCommandService>
    {
        ...
        {
            Assert.Throws<ArgumentException>(() => Subject.Execute(new DownloadedGameFilesScanCommand()));

            Mocker.GetMock<IDownloadedFilesImportService>().Verify(c => c.ProcessRootFolder(It.IsAny<DirectoryInfo>()), Times.Never());
        }
        ...
        public void should_process_folder_if_downloadclientid_is_not_specified()
        {
            ...
            Subject.Execute(new DownloadedGameFilesScanCommand() { Path = _downloadFolder });

            Mocker.GetMock<IDownloadedFilesImportService>().Verify(c => c.ProcessPath(It.IsAny<string>(), ImportMode.Auto, null, null), Times.Once());
        }
        ...
        public void should_process_file_if_downloadclientid_is_not_specified()
        {
            ...
            Subject.Execute(new DownloadedGameFilesScanCommand() { Path = _downloadFile });
        ...
        public void should_process_folder_with_downloadclientitem_if_available()
        {
            ...
            Subject.Execute(new DownloadedGameFilesScanCommand() { Path = _downloadFolder, DownloadClientId = "sab1" });

            Mocker.GetMock<IDownloadedFilesImportService>().Verify(c => c.ProcessPath(_downloadFolder, ImportMode.Auto, _trackedDownload.RemoteRom.Game, _trackedDownload.DownloadItem), Times.Once());
        }
        ...
        public void should_process_folder_without_downloadclientitem_if_not_available()
        {
            ...
            Mocker.GetMock<IDownloadedFilesImportService>().Verify(c => c.ProcessPath(_downloadFolder, ImportMode.Auto, null, null), Times.Once());
        ...
        public void should_warn_if_neither_folder_or_file_exists()
        {
            ...
            Mocker.GetMock<IDownloadedFilesImportService>().Verify(c => c.ProcessPath(It.IsAny<string>(), ImportMode.Auto, null, null), Times.Never());
        ...
        public void should_override_import_mode()
        {
            ...
            Subject.Execute(new DownloadedGameFilesScanCommand() { Path = _downloadFile, ImportMode = ImportMode.Copy });

            Mocker.GetMock<IDownloadedFilesImportService>().Verify(c => c.ProcessPath(It.IsAny<string>(), ImportMode.Copy, null, null), Times.Once());
        }
    }
}
