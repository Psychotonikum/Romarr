...
{
    [TestFixture]
    public class DownloadedFilesImportServiceFixture : CoreTest<DownloadedFilesImportService>
    {
        ...
        public void Setup()
        {
            ...
            Mocker.GetMock<IImportApprovedFiles>()
        ...
        public void should_return_importresult_on_unknown_series()
        {
            ...
            result.First().ImportDecision.LocalGameFile.Should().NotBeNull();
            result.First().ImportDecision.LocalGameFile.Path.Should().Be(fileName);
        ...
        public void should_return_rejection_if_nothing_imported_and_contains_rar_file()
        {
            ...
            var path = @"C:\Test\Unsorted\Game.Title.S01E01.abc-Romarr".AsOsAgnostic();
            var imported = new List<ImportDecision>();
        ...
        [Test]
        public void should_reject_if_download_is_multi_platform()
        {
            GivenValidSeries();
            ...
            result.Count.Should().Be(1);
            result.First().Result.Should().Be(ImportResultType.Rejected);
            result.First().ImportDecision.Rejections.First().Reason.Should().Be(ImportRejectionReason.MultiPlatform);
        ...
        {
            Mocker.GetMock<IImportApprovedFiles>().Verify(c => c.Import(It.IsAny<List<ImportDecision>>(), true, null, ImportMode.Auto),
                Times.Never());
        }
