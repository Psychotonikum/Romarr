...
namespace Romarr.Core.Test.MediaFiles.MediaInfo
{
    [TestFixture]
    [DiskAccessTest]
    public class GameFileInfoReaderFixture : CoreTest<GameFileInfoReader>
    {
        [SetUp]
        public void Setup()
        {
        ...
        public void should_detect_hdr_correctly(int bitDepth, string colourPrimaries, string transferFunction, string[] sideDataTypes, int? doviConfigId, HdrFormat expected)
        {
            ...
            var result = GameFileInfoReader.GetHdrFormat(bitDepth, colourPrimaries, transferFunction, sideData);
