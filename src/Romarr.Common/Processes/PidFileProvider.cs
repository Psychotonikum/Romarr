...
namespace Romarr.Common.Processes
{
    ...
    public class PidFileProvider : IProvidePidFile
    {
        ...
        public void Write()
        {
            ...
            var filename = Path.Combine(_appFolderInfo.AppDataFolder, "romarr.pid");
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                throw new RomarrStartupException(ex, "Unable to write PID file {0}", filename);
            }
        }
    }
}
