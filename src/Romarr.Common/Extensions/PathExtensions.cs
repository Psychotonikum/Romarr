...
namespace Romarr.Common.Extensions
{
    public static class PathExtensions
    {
        ...
        private const string DB = "romarr.db";
        private const string DB_RESTORE = "romarr.restore";
        private const string LOG_DB = "logs.db";
        private const string NLOG_CONFIG_FILE = "nlog.config";
        private const string UPDATE_CLIENT_EXE_NAME = "Romarr.Update";

        private static readonly string UPDATE_SANDBOX_FOLDER_NAME = "romarr_update" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_PACKAGE_FOLDER_NAME = "Romarr" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_FOLDER_NAME = "romarr_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_APPDATA_FOLDER_NAME = "romarr_appdata_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_CLIENT_FOLDER_NAME = "Romarr.Update" + Path.DirectorySeparatorChar;
