...
namespace Romarr.Common
{
    ...
    public class ConsoleService : IConsoleService
    {
        ...
        public void PrintHelp()
        {
            ...
            Console.WriteLine("                 /{0} Don't open Romarr in a browser", StartupContext.NO_BROWSER);
            Console.WriteLine("                 /{0} Start Romarr terminating any other instances", StartupContext.TERMINATE);
