...
{
    [Migration(198)]
    public class parse_title_from_existing_subtitle_files : RomarrMigrationBase
    {
        private static readonly Logger Logger = RomarrLogger.GetLogger(typeof(AggregateSubtitleInfo));
