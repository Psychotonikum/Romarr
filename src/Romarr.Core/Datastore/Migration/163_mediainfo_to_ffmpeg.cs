...
{
    [Migration(163)]
    public class mediainfo_to_ffmpeg : RomarrMigrationBase
    {
        ...
        private HdrFormat MigrateHdrFormat(MediaInfo162 mediaInfo)
        {
            ...
            return GameFileInfoReader.GetHdrFormat(mediaInfo.VideoBitDepth, mediaInfo.VideoColourPrimaries, mediaInfo.VideoTransferCharacteristics, new());
        }
