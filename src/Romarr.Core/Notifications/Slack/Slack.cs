...
using Romarr.Core.Notifications.Slack.Payloads;
...
namespace Romarr.Core.Notifications.Slack
{
    public class Slack : NotificationBase<SlackSettings>
    {
        ...
        public ValidationFailure TestMessage()
        {
            ...
            {
                return new RomarrValidationFailure("Unable to post", _localizationService.GetLocalizedString("NotificationsValidationUnableToSendTestMessage", new Dictionary<string, object> { { "exceptionMessage", ex.Message } }));
            }
