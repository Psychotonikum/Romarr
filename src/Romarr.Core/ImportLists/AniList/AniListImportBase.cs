...
namespace Romarr.Core.ImportLists.AniList
{
    ...
    where TSettings : AniListSettingsBase<TSettings>, new()
    {
        ...
        public const string RedirectUri = "https://auth.servarr.com/v1/anilist_romarr/auth";
        public const string RenewUri = "https://auth.servarr.com/v1/anilist_romarr/renew";
