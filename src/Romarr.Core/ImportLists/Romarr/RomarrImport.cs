...
{
    public class RomarrImport : ImportListBase<RomarrSettings>
    {
        private readonly IRomarrV3Proxy _romarrV3Proxy;
        public override string Name => "Romarr";

        public override ImportListType ListType => ImportListType.Program;
        public override TimeSpan MinRefreshInterval => TimeSpan.FromMinutes(5);

        public RomarrImport(IRomarrV3Proxy romarrV3Proxy,
        ...
        public override ImportListFetchResult Fetch()
        {
            ...
            try
            {
                var remoteGame = _romarrV3Proxy.GetGame(Settings);
                ...
                foreach (var item in remoteGame)
                {
                    ...
                    if (Settings.SyncPlatformMonitoring)
                    {
        ...
        public override object RequestAction(string action, IDictionary<string, string> query)
        {
            ...
            {
                var profiles = _romarrV3Proxy.GetQualityProfiles(Settings);
            ...
            {
                var langProfiles = _romarrV3Proxy.GetLanguageProfiles(Settings);
            ...
            if (action == "getTags")
            {
                var tags = _romarrV3Proxy.GetTags(Settings);
            ...
            {
                var remoteRootFolders = _romarrV3Proxy.GetRootFolders(Settings);
        ...
        {
            failures.AddIfNotNull(_romarrV3Proxy.Test(Settings));
        }
    }
}
