...
namespace Romarr.Core.Configuration
{
    ...
    public class ConfigService : IConfigService
    {
        ...
        public bool AutoUnmonitorPreviouslyDownloadedGameFiles
        {
            get { return GetValueBoolean("AutoUnmonitorPreviouslyDownloadedGameFiles"); }
            set { SetValue("AutoUnmonitorPreviouslyDownloadedGameFiles", value); }
        }
        ...
        public PlatformPackUpgradeType PlatformPackUpgrade
        {
            get { return GetValueEnum("PlatformPackUpgrade", PlatformPackUpgradeType.All); }
            set { SetValue("PlatformPackUpgrade", value); }
        }

        public double PlatformPackUpgradeThreshold
        {
            get { return GetValueDouble("PlatformPackUpgradeThreshold", 100.0); }
            set { SetValue("PlatformPackUpgradeThreshold", value); }
        }
