...
{
    public interface IGameFileInfoReader
    {
        MediaInfoModel GetMediaInfo(string filename);
        TimeSpan? GetRunTime(string filename);
    }

    public class GameFileInfoReader : IGameFileInfoReader
    {
        ...
        public GameFileInfoReader(IDiskProvider diskProvider, Logger logger)
        {
