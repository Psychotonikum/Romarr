...
namespace Romarr.Core.MediaFiles.MediaInfo
{
    public static partial class MediaInfoFormatter
    {
        ...
        private static readonly Logger Logger = RomarrLogger.GetLogger(typeof(MediaInfoFormatter));
        ...
        public static string FormatVideoCodec(MediaInfoModel mediaInfo, string sceneName)
        {
            ...
            Logger.ForDebugEvent()
                  .Message("Unknown file format: '{0}' in '{1}'. Streams: {2}", videoFormat, sceneName, mediaInfo.RawStreamData)
