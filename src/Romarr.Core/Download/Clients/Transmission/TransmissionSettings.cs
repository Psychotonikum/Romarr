...
namespace Romarr.Core.Download.Clients.Transmission
{
    ...
    public class TransmissionSettings : DownloadClientSettingsBase<TransmissionSettings>
    {
        ...
        [FieldDefinition(9, Label = "DownloadClientSettingsRecentPriority", Type = FieldType.Select, SelectOptions = typeof(TransmissionPriority), HelpText = "DownloadClientSettingsRecentPriorityGameFileHelpText")]
        public int RecentTvPriority { get; set; }

        [FieldDefinition(10, Label = "DownloadClientSettingsOlderPriority", Type = FieldType.Select, SelectOptions = typeof(TransmissionPriority), HelpText = "DownloadClientSettingsOlderPriorityGameFileHelpText")]
