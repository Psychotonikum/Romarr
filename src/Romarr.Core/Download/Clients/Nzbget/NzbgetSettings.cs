...
namespace Romarr.Core.Download.Clients.Nzbget
{
    ...
    public class NzbgetSettings : DownloadClientSettingsBase<NzbgetSettings>
    {
        ...
        [FieldDefinition(7, Label = "DownloadClientSettingsRecentPriority", Type = FieldType.Select, SelectOptions = typeof(NzbgetPriority), HelpText = "DownloadClientSettingsRecentPriorityGameFileHelpText")]
        public int RecentTvPriority { get; set; }

        [FieldDefinition(8, Label = "DownloadClientSettingsOlderPriority", Type = FieldType.Select, SelectOptions = typeof(NzbgetPriority), HelpText = "DownloadClientSettingsOlderPriorityGameFileHelpText")]
