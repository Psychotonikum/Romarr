...
using Romarr.Core.Download.Clients.Hadouken.Models;
...
namespace Romarr.Core.Download.Clients.Hadouken
{
    public class Hadouken : TorrentClientBase<HadoukenSettings>
    {
        ...
        private ValidationFailure TestConnection()
        {
            ...
            {
                return new RomarrValidationFailure("Host", _localizationService.GetLocalizedString("DownloadClientValidationUnableToConnect"))
                       {
