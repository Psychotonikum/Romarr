...
namespace Romarr.Core.Download.Clients.Deluge
{
    public class Deluge : TorrentClientBase<DelugeSettings>
    {
        ...
        protected override string AddFromMagnetLink(RemoteRom remoteRom, string hash, string magnetLink)
        {
            ...
            if ((isRecentGameFile && Settings.RecentTvPriority == (int)DelugePriority.First) ||
                (!isRecentGameFile && Settings.OlderTvPriority == (int)DelugePriority.First))
            {
        ...
        public override IEnumerable<DownloadClientItem> GetItems()
        {
            ...
            foreach (var torrent in torrents)
            {
                ...
                // This allows Romarr to delete the torrent as appropriate.
        ...
        private ValidationFailure TestConnection()
        {
            ...
            catch (DownloadClientAuthenticationException ex)
            {
                ...
                return new RomarrValidationFailure("Password", _localizationService.GetLocalizedString("DownloadClientValidationAuthenticationFailure"));
            }
            catch (WebException ex)
            {
                ...
                switch (ex.Status)
                {
                    ...
                    case WebExceptionStatus.ConnectionClosed:
                        return new RomarrValidationFailure("UseSsl", _localizationService.GetLocalizedString("DownloadClientValidationVerifySsl"))
                        {
                    ...
                    case WebExceptionStatus.SecureChannelFailure:
                        return new RomarrValidationFailure("UseSsl", _localizationService.GetLocalizedString("DownloadClientValidationSslConnectFailure"))
                        {
        ...
        private ValidationFailure TestCategory()
        {
            ...
            {
                return new RomarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientDelugeValidationLabelPluginInactive"))
                {
            ...
            if (Settings.GameCategory.IsNotNullOrWhiteSpace() && !labels.Contains(Settings.GameCategory))
            {
                ...
                {
                    return new RomarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientDelugeValidationLabelPluginFailure"))
                    {
            ...
            if (Settings.TvImportedCategory.IsNotNullOrWhiteSpace() && !labels.Contains(Settings.TvImportedCategory))
            {
                ...
                {
                    return new RomarrValidationFailure("TvImportedCategory", _localizationService.GetLocalizedString("DownloadClientDelugeValidationLabelPluginFailure"))
                    {
                        DetailedDescription = _localizationService.GetLocalizedString("DownloadClientDelugeValidationLabelPluginFailureDetail", new Dictionary<string, object> { { "clientName", Name } })
                    };
                }
