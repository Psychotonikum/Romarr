...
namespace Romarr.Core.Download.Clients.UTorrent
{
    public class UTorrent : TorrentClientBase<UTorrentSettings>
    {
        ...
        protected override string AddFromMagnetLink(RemoteRom remoteRom, string hash, string magnetLink)
        {
            ...
            if ((isRecentGameFile && Settings.RecentTvPriority == (int)UTorrentPriority.First) ||
                (!isRecentGameFile && Settings.OlderTvPriority == (int)UTorrentPriority.First))
            {
