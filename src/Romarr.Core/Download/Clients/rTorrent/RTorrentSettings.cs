...
namespace Romarr.Core.Download.Clients.RTorrent
{
    ...
    public class RTorrentSettings : DownloadClientSettingsBase<RTorrentSettings>
    {
        ...
        [FieldDefinition(9, Label = "DownloadClientSettingsRecentPriority", Type = FieldType.Select, SelectOptions = typeof(RTorrentPriority), HelpText = "DownloadClientSettingsRecentPriorityGameFileHelpText")]
        public int RecentTvPriority { get; set; }

        [FieldDefinition(10, Label = "DownloadClientSettingsOlderPriority", Type = FieldType.Select, SelectOptions = typeof(RTorrentPriority), HelpText = "DownloadClientSettingsOlderPriorityGameFileHelpText")]
