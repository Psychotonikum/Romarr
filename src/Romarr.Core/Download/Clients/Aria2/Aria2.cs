...
namespace Romarr.Core.Download.Clients.Aria2
{
    public class Aria2 : TorrentClientBase<Aria2Settings>
    {
        ...
        private ValidationFailure TestConnection()
        {
            ...
            catch (Exception ex)
            {
                ...
                return new RomarrValidationFailure("Host", _localizationService.GetLocalizedString("DownloadClientValidationUnableToConnect", new Dictionary<string, object> { { "clientName", "Aria2" } }))
                {
