...
using Romarr.Core.Download.Clients.DownloadStation.Proxies;
    ...
    public class TorrentDownloadStation : TorrentClientBase<DownloadStationSettings>
    {
        ...
        protected ValidationFailure TestOutputPath()
        {
            try
            {
                ...
                if (downloadDir == null)
                {
                    return new RomarrValidationFailure(nameof(Settings.GameDirectory), _localizationService.GetLocalizedString("DownloadClientDownloadStationValidationNoDefaultDestination"))
                    {
                ...
                {
                    return new RomarrValidationFailure(fieldName, _localizationService.GetLocalizedString("DownloadClientDownloadStationValidationSharedFolderMissing"))
                    {
                ...
                if (!folderInfo.IsDir)
                {
                    return new RomarrValidationFailure(fieldName, _localizationService.GetLocalizedString("DownloadClientDownloadStationValidationFolderMissing"))
                    {
            ...
            catch (DownloadClientAuthenticationException ex)
            {
                ...
                return new RomarrValidationFailure(string.Empty, ex.Message);
            }
            catch (Exception ex)
            {
        ...
        protected ValidationFailure TestConnection()
        {
            ...
            {
                _logger.Error(ex, ex.Message);
                return new RomarrValidationFailure("Username", _localizationService.GetLocalizedString("DownloadClientValidationAuthenticationFailure"))
                {
