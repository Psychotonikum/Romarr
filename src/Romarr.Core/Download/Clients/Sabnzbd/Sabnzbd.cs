...
namespace Romarr.Core.Download.Clients.Sabnzbd
{
    public class Sabnzbd : UsenetClientBase<SabnzbdSettings>
    {
        ...
        protected override string AddFromNzbFile(RemoteRom remoteRom, string filename, byte[] fileContent)
        {
            ...
            var priority = remoteRom.IsRecentGameFile() ? Settings.RecentTvPriority : Settings.OlderTvPriority;
        ...
        private ValidationFailure TestConnectionAndVersion()
        {
            try
            {
                ...
                {
                    return new RomarrValidationFailure("Version", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationDevelopVersion"))
                    {
                        IsWarning = true,
        ...
        private ValidationFailure TestGlobalConfig()
        {
            ...
            {
                return new RomarrValidationFailure("", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationCheckBeforeDownload"))
                {
        ...
        private ValidationFailure TestCategory()
        {
            ...
            if (category != null)
            {
                ...
                {
                    return new RomarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableJobFolders"))
                    {
            ...
            else
            {
                ...
                {
                    return new RomarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientValidationCategoryMissing"))
                    {
                        InfoLink = _proxy.GetBaseUrl(Settings, "config/categories/"),
            ...
            {
                return new RomarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableDisableGameSorting"))
                {
            ...
            {
                return new RomarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableDisableMovieSorting"))
                {
                    InfoLink = _proxy.GetBaseUrl(Settings, "config/sorting/"),
            ...
            {
                return new RomarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableDisableDateSorting"))
                {
                    InfoLink = _proxy.GetBaseUrl(Settings, "config/sorting/"),
