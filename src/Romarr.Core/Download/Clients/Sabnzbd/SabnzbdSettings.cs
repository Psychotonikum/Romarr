...
namespace Romarr.Core.Download.Clients.Sabnzbd
{
    ...
    public class SabnzbdSettings : DownloadClientSettingsBase<SabnzbdSettings>
    {
        ...
        [FieldDefinition(8, Label = "DownloadClientSettingsRecentPriority", Type = FieldType.Select, SelectOptions = typeof(SabnzbdPriority), HelpText = "DownloadClientSettingsRecentPriorityGameFileHelpText")]
        public int RecentTvPriority { get; set; }

        [FieldDefinition(9, Label = "DownloadClientSettingsOlderPriority", Type = FieldType.Select, SelectOptions = typeof(SabnzbdPriority), HelpText = "DownloadClientSettingsOlderPriorityGameFileHelpText")]
