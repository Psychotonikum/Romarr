...
namespace Romarr.Core.Download.Clients.QBittorrent
{
    public class QBittorrent : TorrentClientBase<QBittorrentSettings>
    {
        ...
        protected override string AddFromMagnetLink(RemoteRom remoteRom, string hash, string magnetLink)
        {
            ...
            var isRecentGameFile = remoteRom.IsRecentGameFile();
            var moveToTop = (isRecentGameFile && Settings.RecentTvPriority == (int)QBittorrentPriority.First) || (!isRecentGameFile && Settings.OlderTvPriority == (int)QBittorrentPriority.First);
        ...
        private ValidationFailure TestConnection()
        {
            try
            {
                ...
                if (version < Version.Parse("1.5"))
                {
                    ...
                    return new RomarrValidationFailure("Host", _localizationService.GetLocalizedString("DownloadClientValidationErrorVersion",
                ...
                else if (version < Version.Parse("1.6"))
                {
                    ...
                    {
                        return new RomarrValidationFailure("Category", _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryUnsupported"))
                        {
                ...
                else if (Settings.GameCategory.IsNullOrWhiteSpace())
                {
                    ...
                    return new RomarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryRecommended"))
                    {
                        IsWarning = true,
                ...
                {
                    return new RomarrValidationFailure(string.Empty, _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationRemovesAtRatioLimit"))
                    {
            ...
            catch (DownloadClientAuthenticationException ex)
            {
                ...
                return new RomarrValidationFailure(Settings.ApiKey.IsNotNullOrWhiteSpace() ? "ApiKey" : "Username", _localizationService.GetLocalizedString("DownloadClientValidationAuthenticationFailure"))
                {
            ...
            catch (WebException ex)
            {
                ...
                {
                    return new RomarrValidationFailure("Host", _localizationService.GetLocalizedString("DownloadClientValidationUnableToConnect", new Dictionary<string, object> { { "clientName", Name } }))
                    {
                        DetailedDescription = _localizationService.GetLocalizedString("DownloadClientValidationUnableToConnectDetail")
                    };
                }

                return new RomarrValidationFailure(string.Empty, _localizationService.GetLocalizedString("DownloadClientValidationUnknownException", new Dictionary<string, object> { { "exception", ex.Message } }));
            }
            catch (Exception ex)
            {
        ...
        private ValidationFailure TestCategory()
        {
            ...
            if (Settings.GameCategory.IsNotNullOrWhiteSpace() && !labels.ContainsKey(Settings.GameCategory))
            {
                ...
                {
                    return new RomarrValidationFailure("GameCategory", _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryAddFailure"))
                    {
            ...
            if (Settings.TvImportedCategory.IsNotNullOrWhiteSpace() && !labels.ContainsKey(Settings.TvImportedCategory))
            {
                ...
                {
                    return new RomarrValidationFailure("TvImportedCategory", _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryAddFailure"))
                    {
                        DetailedDescription = _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryAddFailureDetail")
                    };
                }
        ...
        private ValidationFailure TestPrioritySupport()
        {
            ...
            try
            {
                ...
                if (!config.QueueingEnabled)
                {
                    ...
                    {
                        return new RomarrValidationFailure(nameof(Settings.RecentTvPriority), _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationQueueingNotEnabled"))
                        {
                    ...
                    {
                        return new RomarrValidationFailure(nameof(Settings.OlderTvPriority), _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationQueueingNotEnabled"))
                        {
                            DetailedDescription = _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationQueueingNotEnabledDetail")
                        };
                    }
        ...
        private ValidationFailure TestGetTorrents()
        {
            ...
            catch (Exception ex)
            {
                ...
                return new RomarrValidationFailure(string.Empty, _localizationService.GetLocalizedString("DownloadClientValidationTestTorrents", new Dictionary<string, object> { { "exceptionMessage", ex.Message } }));
            }
