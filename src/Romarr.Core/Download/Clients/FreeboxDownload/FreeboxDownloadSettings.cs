...
namespace Romarr.Core.Download.Clients.FreeboxDownload
{
    ...
    public class FreeboxDownloadSettings : DownloadClientSettingsBase<FreeboxDownloadSettings>
    {
        ...
        [FieldDefinition(8, Label = "DownloadClientSettingsRecentPriority", Type = FieldType.Select, SelectOptions = typeof(FreeboxDownloadPriority), HelpText = "DownloadClientSettingsRecentPriorityGameFileHelpText")]
        public int RecentPriority { get; set; }

        [FieldDefinition(9, Label = "DownloadClientSettingsOlderPriority", Type = FieldType.Select, SelectOptions = typeof(FreeboxDownloadPriority), HelpText = "DownloadClientSettingsOlderPriorityGameFileHelpText")]
