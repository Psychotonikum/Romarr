...
namespace Romarr.Core.Validation
{
    public static class RuleBuilderExtensions
    {
        ...
        public static IRuleBuilderOptions<T, string> ValidUrlBase<T>(this IRuleBuilder<T, string> ruleBuilder, string example = "/romarr")
        {
        ...
        {
            return ruleBuilder.WithState(v => RomarrValidationState.Warning);
        }

        public static IRuleBuilderOptions<T, string> StartsOrEndsWithRomarr<T>(this IRuleBuilder<T, string> ruleBuilder)
        {
            ruleBuilder.SetValidator(new NotEmptyValidator(null));
            return ruleBuilder.SetValidator(new RegularExpressionValidator("^Romarr|Romarr$")).WithMessage("Must start or end with Romarr");
        }
    }
}
