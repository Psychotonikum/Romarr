...
namespace Romarr.Core.Analytics
{
    ...
    public class AnalyticsService : IAnalyticsService
    {
        ...
        public bool InstallIsActive
        {
            get
            {
                var lastRecord = _historyService.Paged(new PagingSpec<FileHistory>() { Page = 0, PageSize = 1, SortKey = "date", SortDirection = SortDirection.Descending }, null, null);
