...
namespace Romarr.Core.HealthCheck
{
    public class HealthCheck : ModelBase
    {
        ...
        {
            return new HttpUri("https://wiki.servarr.com/romarr/system") + new HttpUri(fragment);
        }
    }
    ...
    public enum HealthCheckReason
    {
        ...
        RemotePathMappingDownloadPermissionsGameFile,
        ...
        RemotePathMappingImportGameFileFailed,
