...
namespace Romarr.Core.HealthCheck
{
    public class ServerSideNotificationService : HealthCheckBase
    {
        ...
        private readonly IRomarrCloudRequestBuilder _cloudRequestBuilder;
        private readonly IConfigFileProvider _configFileProvider;
        private readonly Logger _logger;

        public ServerSideNotificationService(IHttpClient client, IRomarrCloudRequestBuilder cloudRequestBuilder, IConfigFileProvider configFileProvider, ILocalizationService localizationService, Logger logger)
