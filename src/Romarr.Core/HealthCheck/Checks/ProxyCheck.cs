...
namespace Romarr.Core.HealthCheck.Checks
{
    ...
    public class ProxyCheck : HealthCheckBase
    {
        ...
        public ProxyCheck(IRomarrCloudRequestBuilder cloudRequestBuilder, IConfigService configService, IHttpClient client, Logger logger, ILocalizationService localizationService)
