...
namespace Romarr.Core.Update
{
    ...
    public class UpdatePackageProvider : IUpdatePackageProvider
    {
        ...
        public UpdatePackageProvider(IHttpClient httpClient, IRomarrCloudRequestBuilder requestBuilder, IAnalyticsService analyticsService, IPlatformInfo platformInfo, IMainDatabase mainDatabase)
        {
