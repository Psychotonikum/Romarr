...
namespace Romarr.Api.V3.Wanted
{
    ...
    public class MissingController : RomControllerWithSignalR
    {
        ...
        public PagingResource<RomResource> GetMissingGameFiles([FromQuery] PagingRequestResource paging, bool includeSeries = false, bool includeImages = false, bool monitored = true)
        {
