...
namespace Romarr.Test.Common.AutoMoq
{
    [DebuggerStepThrough]
    public class AutoMoqer
    {
        ...
        private void SetupAutoMoqer(IContainer container)
        {
            ...
            AssemblyLoader.RegisterNativeResolver(new[] { "System.Data.SQLite", "Romarr.Core" });
        }
        ...
        {
            var assemblyName = "Romarr.Windows";

            if (OsInfo.IsNotWindows)
            {
                assemblyName = "Romarr.Mono";
            }
