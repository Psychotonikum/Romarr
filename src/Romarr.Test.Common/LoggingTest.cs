...
namespace Romarr.Test.Common
{
    public abstract class LoggingTest
    {
        ...
        protected static readonly Logger TestLogger = RomarrLogger.GetLogger("TestLogger");
        ...
        protected static void InitLogging()
        {
            ...
            lock (_initLock)
            {
                if (LogManager.Configuration == null || LogManager.Configuration.AllTargets.None(c => c is ExceptionVerification))
                {
                    ...
                    Enum.TryParse<TestLogOutput>(Environment.GetEnvironmentVariable("ROMARR_TESTS_LOG_OUTPUT"), out var logOutput);
