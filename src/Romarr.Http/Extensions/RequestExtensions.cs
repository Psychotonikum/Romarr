...
namespace Romarr.Http.Extensions
{
    public static class RequestExtensions
    {
        ...
        {
            if (request.Headers.TryGetValue("X-Romarr-Client", out var source))
            {
                return source;
            }

            return Romarr.Common.Http.UserAgentParser.ParseSource(request.Headers["User-Agent"]);
        }
