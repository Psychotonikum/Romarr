...
const platformPackUpgradeOptions: EnhancedSelectInputValue<string>[] = [
  {
    key: 'all',
    get value() {
        ...
        {hasSettings && isPopulated && !error ? (
          ...
          >
              ...
              <FieldSet legend={translate('Importing')}>
                ...
                {showAdvancedSettings && (
                  <>
                    ...
                    >
                      <FormLabel>
                        {translate('PlatformPackUpgradeAllowLabel')}
                      </FormLabel>
                      <FormInputGroup
                        type={inputTypes.SELECT}
                        name="platformPackUpgrade"
                        helpText={translate('PlatformPackUpgradeAllowHelpText')}
                        helpTextWarning={
                          settings.platformPackUpgrade.value === 'any'
                            ? translate('PlatformPackUpgradeAllowAnyWarning')
                            : undefined
                        }
                        values={platformPackUpgradeOptions}
                        onChange={handleInputChange}
                        {...settings.platformPackUpgrade}
                      />
                    </FormGroup>

                    {settings.platformPackUpgrade.value === 'threshold' && (
                      <FormGroup
                        advancedSettings={showAdvancedSettings}
                        isAdvanced={true}
                        size={sizes.MEDIUM}
                      >
                        <FormLabel>
                          {translate('PlatformPackUpgradeThresholdLabel')}
                        </FormLabel>
                        <FormInputGroup
                          type={inputTypes.FLOAT}
                          name="platformPackUpgradeThreshold"
                          unit="%"
                          step={0.01}
                          min={0}
                          max={100}
                          helpTexts={[
                            translate('PlatformPackUpgradeThresholdHelpText'),
                            translate(
                              'PlatformPackUpgradeThresholdHelpTextExample',
                              {
                                numberFiles: 2,
                                totalFiles: 8,
                          ...
                          onChange={handleInputChange}
                          {...settings.platformPackUpgradeThreshold}
                        />
                      </FormGroup>
                    )}
                  </>
            ...
            <FieldSet legend={translate('FileManagement')}>
              <FormGroup size={sizes.MEDIUM}>
                <FormLabel>{translate('UnmonitorDeletedFiles')}</FormLabel>

                <FormInputGroup
                  type={inputTypes.CHECK}
                  name="autoUnmonitorPreviouslyDownloadedFiles"
                  helpText={translate('UnmonitorDeletedEpisodesHelpText')}
                  onChange={handleInputChange}
                  {...settings.autoUnmonitorPreviouslyDownloadedFiles}
                />
              </FormGroup>
