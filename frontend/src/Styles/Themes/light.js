const romarrBlue = '#35c5f4';
const romarrAlternateBlue = '#2193b5';
const darkGray = '#888';
...
module.exports = {
  ...
  themeBlue: romarrBlue,
  themeAlternateBlue: romarrAlternateBlue,
  themeRed: '#c4273c',
  ...
  // Header
  pageHeaderBackgroundColor: romarrAlternateBlue,
