...
import styles from './GameTypeSelectInputOption.css';
...
function GameTypeSelectInputOption(props: GameTypeSelectInputOptionProps) {
...
export default GameTypeSelectInputOption;
